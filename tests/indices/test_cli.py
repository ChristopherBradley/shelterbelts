...
def test_cli_defaults_match_function_defaults(func, parser_func, exclude_args):
    """Verify CLI argument defaults match function signature defaults for all indices modules.
    
    This test ensures that if someone updates a function's default parameter,
    they remember to update the corresponding CLI argument default as well.
    """
