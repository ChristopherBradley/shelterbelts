...
def test_sentinel():
    ...
    download_ds2(sample_tif, start_date="2020-01-01", end_date="2021-01-01", outdir="outdir", stub="g2_26729")
    download_ds2(sample_tif, start_date="2020-06-01", end_date="2021-06-01", outdir="outdir", stub="g2_26729")
