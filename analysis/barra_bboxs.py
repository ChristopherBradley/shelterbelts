...
barra_bboxs_full = '/scratch/xe2/cb8590/tmp/barra_bboxs.gpkg'  # Regenerate with get_barra_bboxs() if missing (scratch gets purged)
...
# For agricultural-region-only tiles, use analysis/split_ag_bboxs.py instead of state='aus' here
# (it filters barra_bboxs_aus.gpkg against the grazing/no-BWH mask before chunking).

# -

# Unrelated NSW DEM conversion helper that lived in this file historically -- kept for fidelity
# with the restored version, not actually about BARRA bboxs.
