...
# Nick tifs
# param_stubs=(subfolder_1 subfolder_2 subfolder_3 subfolder_4 subfolder_5 subfolder_6 subfolder_7 subfolder_8 subfolder_9 subfolder_10 subfolder_11 subfolder_12 subfolder_13 subfolder_14 subfolder_15)

# NSW stubs — uncomment for full run
...
# Test stub — single tile to verify and estimate compute
# param_stubs=(lat_36_lon_148)
