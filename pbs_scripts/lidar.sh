...
# Re-running on lidar that went over the memory allocation

## Run lidar.pbs on a single folder
BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587116"
...
BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587116"
laz_folder="$BASE_FOLDER/laz_files/ACT Government/Point Clouds/AHD/subfolder_2"
CHM_FOLDER="$BASE_FOLDER/chm"
qsub -v LAZ_FOLDER="$laz_folder",CHM_FOLDER="$CHM_FOLDER" lidar.pbs

BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587116"
laz_folder="$BASE_FOLDER/laz_files/ACT Government/Point Clouds/AHD/subfolder_3"
CHM_FOLDER="$BASE_FOLDER/chm"
qsub -v LAZ_FOLDER="$laz_folder",CHM_FOLDER="$CHM_FOLDER" lidar.pbs
...
# BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587085"
# # laz_folder="$BASE_FOLDER/laz_files/ACT Government/Point Clouds/AHD/subfolder_1"
# laz_folder="$BASE_FOLDER/laz_files/NSW Government - Spatial Services/Point Clouds/AHD/subfolder_2"
# CHM_FOLDER="$BASE_FOLDER/chm"
# qsub -v LAZ_FOLDER="$laz_folder",CHM_FOLDER="$CHM_FOLDER" lidar.pbs

# BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587120"
# laz_folder="$BASE_FOLDER/laz_files/ACT Government/Point Clouds/AHD/subfolder_1"
# # laz_folder="$BASE_FOLDER/laz_files/NSW Government - Spatial Services/Point Clouds/AHD/subfolder_2"
# CHM_FOLDER="$BASE_FOLDER/chm"
# qsub -v LAZ_FOLDER="$laz_folder",CHM_FOLDER="$CHM_FOLDER" lidar.pbs

# BASE_FOLDER="/scratch/xe2/cb8590/lidar/DATA_587127"
# laz_folder="$BASE_FOLDER/laz_files/ACT Government/Point Clouds/AHD/subfolder_1"
# # laz_folder="$BASE_FOLDER/laz_files/NSW Government - Spatial Services/Point Clouds/AHD/subfolder_2"
# CHM_FOLDER="$BASE_FOLDER/chm"
# qsub -v LAZ_FOLDER="$laz_folder",CHM_FOLDER="$CHM_FOLDER" lidar.pbs
