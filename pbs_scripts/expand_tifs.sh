...
folder_year=barra_trees_s4_ag_noxy_df_4326_2025
gpkg=/scratch/xe2/cb8590/barra_trees_s4_ag_noxy_df_4326_2025/subfolders/subfolders__footprints.gpkg

# Better version, dynamically pull the stub list from the actual regional subfolders present, rather than hardcoding
stubs=($(ls -d /scratch/xe2/cb8590/${folder_year}/subfolders/lat_*/ | xargs -n1 basename))
echo "Found ${#stubs[@]} stubs"
