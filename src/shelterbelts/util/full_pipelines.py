...
# percent_tif = '/scratch/xe2/cb8590/lidar_30km_old/DATA_717827/DATA_717827_merged_percentcover_res10_height2m.tif' # The shelter metrics currently takes too long when running on a tif this big
threshold = 10
outdir='/scratch/xe2/cb8590'
stub = None

chm_tif = '/scratch/xe2/cb8590/lidar_30km_old/DATA_717827/uint8_chm_res1/Junee201502-PHO3-C0-AHD_5906174_55_0002_0002_chm_res1_uint8.tif'
...
# %%time
ds_shelter = shelter_categories(None, distance_threshold=10, density_threshold=5, outdir=outdir, stub=stub, savetif=False, plot=False, ds=ds_tree_categories)
# 6 secs for a 30kmx30km area

ds_shelter['cover_categories'] = ds_shelter['shelter_categories']  # Skipping the worldcover for now

# %%time
ds_buffer = buffer_categories(None, None, buffer_width=3, outdir=outdir, stub=stub, savetif=False, plot=False, ds=ds_shelter, ds_gullies=ds_hydrolines)
...
ds_linear, df_patches = patch_metrics(None, outdir, stub, ds=ds_buffer, plot=False, save_csv=False, save_labels=False) 
# # Took longer than 41 minutes for 30kmx30km. But almost instant with just a 1kmx1km. 
