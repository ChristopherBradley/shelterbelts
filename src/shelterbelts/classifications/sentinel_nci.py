...
def parse_arguments():
    ...
    parser.add_argument("--gpkg", type=str, required=True, help="A gpkg with: (filename, [start_date], [end_date], geometry), generated by util/bounding_boxes.py. If the start_date and end_date columns exist, then they override the extra command line arguments.")
...
if __name__ == '__main__':
    ...
    run_download_gdf(gdf, outdir, args.start_date, args.end_date)
