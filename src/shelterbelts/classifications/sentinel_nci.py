...
def parse_arguments():
    ...
    parser.add_argument("--filepath", type=str, required=True, help="A gpkg with: (filename, [start_date], [end_date], geometry), generated by util/bounding_boxes.py. If the start_date and end_date columns exist, then they override the extra command line arguments.")
