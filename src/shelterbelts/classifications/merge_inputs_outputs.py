...
def preprocess(sentinel_folder, tree_folder=None, outdir=".", radius=4, spacing=10, outlines_gpkg=None, limit=None):
    ...
    ----------
        ...
        outlines_folder: Extra metadata such as koppen_class generated by koppen.py. Should contain at least a column 'filename' corresponding to the sentinel_filenames
    ...
    filename = os.path.join(outdir, f"preprocessed.feather")
