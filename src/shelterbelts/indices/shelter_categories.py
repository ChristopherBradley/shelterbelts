...
def shelter_categories(category_tif, wind_ds=None, height_tif=None, outdir='.', stub=None, wind_method='MOST_COMMON', wind_threshold=15, distance_threshold=20, density_threshold=10, minimum_height=10, savetif=True, plot=True):
    ...
    ----------
        ...
        stub: Prefix for output files. If not specified, then it appends 'shelter_categories' to the original filename.
