...
def shelter_categories(linear_data, wind_data=None, height_tif=None, fixed_height_mask=None, outdir='.', stub='TEST',
    ...
    fixed_height_mask : xarray.DataArray, optional
        Boolean mask (True = use the fixed pixel-based reach instead of height_tif) for tree pixels
        with no real canopy height yet, e.g. hypothetical newly-planted opportunity trees in
        opportunity_shelter(). Ignored unless height_tif is also given.
    outdir : str, optional
