...
def buffer_categories(cover_data, gullies_data, ridges_data=None, roads_data=None, outdir=".", stub="TEST", buffer_width=4, savetif=True, plot=True):
...
def parse_arguments():
    ...
    parser.add_argument('--buffer_width', default=4, type=int, help='Number of pixels away from the feature that still counts as within the buffer (default: 4)')
