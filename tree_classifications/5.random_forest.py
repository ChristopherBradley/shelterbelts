...
sample_sizes = [1000, 10000, 60000, 100000, 200000]

# %%time
for sample_size in sample_sizes:
    # Start out by training on just 60k samples like in Stewart et al. 2025
    df_60k = df.sample(n=sample_size, random_state=random_state)
    ...
    print(f'sample_size: {sample_size}, Accuracy: {accuracy * 100:.2f}%' )
...
# I should be expecting a validation accuracy of 0.93 based on Stewart et al. 2025. I'm getting 94% accuracy if I increase the sample size to 200k
